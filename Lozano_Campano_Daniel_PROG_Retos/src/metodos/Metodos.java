...
public class Metodos {
	...
	/**
	 * Metodo java de ordenaci�n por selecci�n
	 * 
	 * @param A
	 */
	...
	/**
	 * Metodo java de ordenaci�n quicksort
	 * 
	 * @param A
	 * @param izq
	 * @param der
	...
	public static void lecturaArray(int[] array, int menor, int pow) {
		for (int i = 0; i < array.length; i++) {
			do {
				tryCatchInt();
			} while (num < menor || num > pow);
			array[i] = num;
		}
	}
}
