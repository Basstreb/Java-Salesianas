...
public class EjemploList {
	...
	public static void main(String[] args) {
		...
		listaPersonas.add(new Persona("23456789B", "Juan", "Martinez", LocalDate.of(1991, 2, 3)));
		listaPersonas.add(new Persona("34567890C", "Ana", "Ramirez", LocalDate.of(1992, 3, 4)));
		listaPersonas.add(new Persona("45678901D", "Maria", "Lopez", LocalDate.of(1993, 4, 5)));

		// Acceso posicional (tercera posicion)
		...
		// Anadir un nuevo elemento al final de la lista
		listaPersonas.add(new Persona("56789012E", "Julio", "Azcirate", LocalDate.of(1994, 5, 6)));

		// Anadir/modificar un elemento en medio de la lista
		listaPersonas.set(2, new Persona("67890123F", "Alfonso", "Garcia", LocalDate.of(1995, 6, 7)));
